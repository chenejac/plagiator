...
var AuthService = /** @class */ (function () {
    function AuthService(http, router) {
        ...
        this.baseUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].baseUrl + "api";
    }
...
var environment = {
    production: true,
    baseUrl: 'http://minis.uns.ac.rs/plagiator/'//'/plagiator' //'https://127.0.0.1:5555/api/'
};
